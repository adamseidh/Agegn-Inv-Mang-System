...
function Checkout() {
  ...
  const handleSubmit = async () => {
    ...
    if (!userId) {
      alert("Please Login up or Create account to submit order");
      return;
    }
    ...
    setError(null);
    console.log("ehre i suer id", userId);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative w-full h-64">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
          <h1 className="text-white text-3xl md:text-4xl font-bold uppercase mb-4 text-center">
          ...
          <div className="lg:w-2/3">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold mb-6 pb-2 border-b border-primaryColor">
                Your Product List ({cart.length} items)
              </h2>
