...
import ProductItemCarousel from "./productItemCarousal";
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="flex lg:flex-row flex-col gap-4 lg:p-0">
        ...
        <div className="flex lg:w-1/4 bg-gray-100">
          <div className="flex flex-col fixed z-20 bg-gray-100 py-4 w-full lg:w-1/4 shadow-md">
            <div className="flex flex-row items-center justify-between px-4">
              {customerId && (
                <a
                  className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-primaryColor hover:opacity-75"
                  href="/account"
                >
                  <FontAwesomeIcon
                    icon={faUserShield}
                    className="text-lg leading-lg text-primaryColor"
                  />
