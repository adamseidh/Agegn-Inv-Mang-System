...
const QuarterlyReport = ({
  ...
  const filterByQuarter = (items, dateField) => {
  ...
  const quarterPurchases = filterByQuarter(purchasedProducts, "purchase_date");
  const quarterSales = filterByQuarter(soldProducts, "salesDate");
  const quarterIncome = filterByQuarter(otherIncome, "createdAt");
  const quarterExpenses = filterByQuarter(otherExpenses, "createdAt");
  ...
  return (
    <div className="mt-6">
      <h2 className="text-xl font-semibold mb-4">
        Quarterly Report ({format(quarterStart, "MMM yyyy")} -{" "}
        {format(quarterEnd, "MMM yyyy")})
      </h2>
        ...
        <div className="bg-white p-4 rounded shadow">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {quarterPurchases.map((purchase, i) => (
                  <tr key={i}>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
