...
const AddProduct = ({ isOpen, close, addProduct }) => {
    ...
    const addCostField = () => {
        setProduct({ ...product, costs: [...product.costs, { title: "", amount: "" }] });
    };
    ...
    const calculateSellingPrice = () => {
        ...
        const sellingPrice = (parseFloat(totalCost) + parseFloat(profit)).toFixed(2);
        return sellingPrice;
    };
            ...
            >
                <div className="flex flex-col h-full ">
                    <div className="flex justify-between mb-6 border-b pb-1">
                        ...
                        <button onClick={close} className='text-2xl hover:text-red-700 text-red-500'>
                            <FaXmark />
                        </button>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-6 flex-1 scrollable-column overflow-y-auto">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-2  border rounded-lg p-6 shadow-md ">
                            <h4 className=" col-span-3 font-bold text-lg">Product Information</h4>
                            ...
                            <div className="flex flex-row items-center gap-2 py-2 border-t mt-3 pt-3">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={(e) => handleChange(e, "profitPercent", e.target.value)}
                                        onWheel={(e) => {
                                            e.target.blur()
                                        }}
                                        required
