        ...
        <div>
            ...
            >
                <DatagridConfigurable
                    ...
                    <TextField source="purchase_price" label="Purchase Price" />
                    <TextField source="purchase_status" label="Product Status" />
                    <ImageField
...
const CreateItem = (props) => {
    ...
    const fetchType = () => {
        ...
        axios.get(`${serverHost}/productType`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        }).then(resp => {
        ...
        <Create {...props}>
            <SimpleForm onSubmit={handleSubmit}>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={4} >
                        <NumberInput source="low_level" label="Low Level Quantity" sx={NumberInputStyle} fullWidth />

                    </Grid>

                    <Grid item xs={12}  >
                        <TextInput source="description" label="Product Description" sx={NumberInputStyle} fullWidth />
...
export { PurchaseList, CreateItem, EditItem, ShowAnItem };
