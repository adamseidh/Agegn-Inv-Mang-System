...
const {
  ...
  deleteSalesPayment,
  aSalesPayments,
} = require("./functions/Inventory/Sells/payments");
const {
  SalesUpcamingPayments,
  checkSalesUpcamingPayments,
} = require("./functions/Notifications/salesUpcomingPayments");
const {
  SalesPayments,
  checkSalesPayments,
...
app.get("/SalesUpcamingPayments", SalesUpcamingPayments);

app.get("/SalesUpcamingPayments/:id", fetchSellsProducts);

app.get("/SalesReachedaymentsList", SalesPayments);
...
app.delete("/PurchaseList/:id", verifyToken, deletePurchase);
...
app.post("/addSellsOnEdit", verifyToken, addSellsOnEdit);

app.delete("/deleteSalesProduct/:id", verifyToken, deleteSalesProduct);

app.delete("/salesList/:id", verifyToken, deleteSales);
...
app.get("/aSalesPayments/:id", verifyToken, aSalesPayments);

app.delete("/deleteSalesPayment/:id", verifyToken, deleteSalesPayment);

app.put(
  "/updateSalesPayment/:id",
  verifyToken,
  upload.single("image"),
  updateSalesPayment
);
