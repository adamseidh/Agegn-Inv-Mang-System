...
const { FetchUsers, FetchUser, GetUserRole, Users, EditUser, DeleteUser, SigleUser } = require('./functions/users');
const { Account, EditAccount, showAccount, FetchUserName } = require('./functions/account');
const { Articles, CreateArticle, deleteArticle, AnArticle, EditArticle } = require('./functions/articles');
const { verifyToken } = require('./middleware/jwt');
const { Messages, InsertMessage, AMessage, deleteMessage } = require('./functions/messages');
const { Category, singleCategory, EditCategory, AddCategory, deleteCategory } = require('./functions/Inventory/category');
const { ProductType, singleProductType, EditProductType, AddProductType, deleteProductType } = require('./functions/Inventory/type');
const { Items, AnItem, EditItem, CreateItem, deleteItem } = require('./functions/Inventory/items');
const { Supplier, singleSupplier, EditSupplier, AddSupplier, deleteSupplier } = require('./functions/Inventory/suppliers');
const { PurchaseList } = require('./functions/Inventory/PurchaseList/purchaseList');
const { AddPurchase } = require('./functions/Inventory/PurchaseList/addPurchase');
...
// add purchase List
app.post("/addPurchase", verifyToken, upload.fields([
    { name: "productsImages" },
    { name: "paymentImages" },
]), AddPurchase);
